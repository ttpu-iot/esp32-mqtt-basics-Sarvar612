...
const char* password = "Turin_2024@!";
...
// ===== Topics (CHANGE NAME) =====
const char* topic_btn = "ttpu/iot/sarvar/events/button";
const char* topic_display = "ttpu/iot/sarvar/display";

const char* topic_red    = "ttpu/iot/sarvar/led/red";
const char* topic_green  = "ttpu/iot/sarvar/led/green";
const char* topic_blue   = "ttpu/iot/sarvar/led/blue";
const char* topic_yellow = "ttpu/iot/sarvar/led/yellow";
...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  if (text && strcmp(topic, topic_display) == 0) {
    ...
    lcd.setCursor(0, 0);
    lcd.print(String(text).substring(0, 16));
